...
class TypeOut extends Component {
  render() {
    return (
        <div style={{ width: '25%', maxWidth: '800px',  flexDirection: 'column', alignItems: 'center',marginLeft: '10px', marginBottom: '10px' }}>    
                    <div className="table-container" style={{ maxWidth: '97%', maxHeight: '400px'}}>
                    ...
                    <th style={{backgroundColor: '#005B9D',color: 'white',padding: '2px',textAlign: 'center',border: '2px solid #005B9D'}}>จำนวนรถขาออก</th>
                    </tr>
                        </thead>
                        <tbody>
                        <tr>
